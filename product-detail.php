...
<!-- Mirrored from uiparadox.co.uk/templates/toys-shop/v2/product-detail.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Feb 2026 12:38:24 GMT -->
<head>
    <meta charset="UTF-8">
...
<body class="tt-smooth-scroll">
    ...
    <div id="scroll-container" class="main-wrapper">
        ...
        <main class="main-wrapper">
                    ...
                    <div class="container-fluid">
                        <div class="title-banner-heading pt-40 pb-16 text-center">
                            <div class="row align-items-center row-gap-3">
                                ...
                                <div class="col-md-4">
                                    <h1 class="black fw-700 text-center">Product Detail</h1>
                                </div>
                                <div class="col-md-4">
            ...
            <section class="shop-detail-page py-80">
                <div class="container-fluid">
                            ...
                            <div class="col-lg-6">
                                <div class="product-text-container bg-white br-20">
                                    <div class="d-flex align-items-center gap-12 mb-16">
                                        <h4 class="fw-600 black">Cuddly Animal Pals</h4>
                                        <span class="label subtitle fw-400">In Stock</span>
                                    </div>
                                    <div class="d-flex align-items-center flex-wrap gap-8 mb-16">
                                        <h6 class="orange-1">★★★★★</h6>
                                        <p class="black">(02 Customer Reviews)</p>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between mb-24">
                                        <div class="d-flex align-items-center gap-16">
                                            <h5 class="fw-500 black">$18.00</h5>
                                            <p class="text-decoration-line-through light-gray">$20.00</p>
                                            <div class="label subtitle fw-400">-16%</div>
                                        </div>
                                        <ul class="side-icons list-unstyled mb-0">
                                            <li>
                                    ...
                                    <p class="light-gray mb-32">
                                        ...
                                        pretium ac varius gravida massa. Pulvinar donec vitae rutrum hac porta nulla mauris scelerisque. Scelerisque gravida
                                        ac ut sodales. Nulla amet sit dignissim facilisis.
                                    </p>
                                    <div class="product-color mb-32">
                                        <ul class="unstyled list">
                                            <li>
                                                <p class="black fw-600">Colors:</p>
                                            </li>
                                            <li>
                                                <label for="radio-23"
                                                    class="d-flex align-items-center h-21 light-black font-sec fw-500">
                                                    <input type="radio" id="radio-23" name="muhRadio"
                                                        class="radio-5" value="radio-23" checked>
                                                </label>
                                            </li>
                                            <li>
                                                <label for="radio-24"
                                                    class="d-flex align-items-center h-21 light-black font-sec fw-500">
                                                    <input type="radio" id="radio-24" name="muhRadio"
                                                        class="radio-6" value="radio-24">
                                                </label>
                                            </li>
                                            <li>
                                                <label for="radio-25"
                                                    class="d-flex align-items-center h-21 light-black font-sec fw-500">
                                                    <input type="radio" id="radio-25" name="muhRadio"
                                                        class="radio-7" value="radio-25">
                                                </label>
                                            </li>
                                            ...
                                            <li>
                                                <label for="radio-22"
                                                    class="d-flex align-items-center h-21 light-black font-sec fw-500">
                                                    <input type="radio" id="radio-22" name="muhRadio"
                                                        class="radio-4" value="radio-22">
                                                </label>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="quantity quantity-wrap mb-12">
                                    ...
                                    <div class="row mb-24 row-gap-2">
                                        <div class="col-md-6">
                                            <a href="shop-grid.php" class="cus-btn light-btn w-100">
                                    ...
                                    <div class="d-flex align-items-center gap-12 mb-32">
                                        <p class="fw-600 black">Notice:</p>
                                        <p>Heavy snowfall and ice can block vital roadways, causing significant delays in shipping.</p>
                                    </div>
                                    <div id="accordionExample" class="mb-32">
                                        <div class="hr-line bg-light-gray"></div>
                                        <div class="faq-block">
                                            <a href="#" class="accordion-button" data-bs-toggle="collapse" data-bs-target="#faq1" aria-expanded="true" aria-controls="faq1">Description
                                            </a>
                                            <div id="faq1" class="accordion-collapse collapse show" aria-labelledby="faq1" data-bs-parent="#accordionExample">
                                                <p>The <span class="black"> Clean Wave Automatic Washing Machine</span> simplifies laundry with advanced cleaning technology. It features multiple
                                                    wash cycles, water level sensors, and a quiet, energy-efficient motor. Designed for modern homes, its sleek design
                                                    fits any space, while the intuitive digital interface makes operation easy. Whether handling delicate fabrics or
                                                    heavy loads, the Clean Wave ensures thorough cleaning every time.
                                                </p>
                                            </div>
                                        </div>
                                        <div class="hr-line bg-light-gray"></div>
                                        <div class="faq-block">
                                            <a href="#" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#faq2" aria-expanded="true" aria-controls="faq2">Shipping and Returns
                                            </a>
                                            <div id="faq2" class="accordion-collapse collapse " aria-labelledby="faq2" data-bs-parent="#accordionExample">
                                                <p>The Clean Wave Automatic Washing Machine simplifies laundry with advanced cleaning technology. It
                                                    features multiple wash cycles, water level sensors, and a quiet, energy-efficient motor. Designed for modern homes,
                                                    its sleek design fits any space, while the intuitive digital interface makes operation easy. Whether handling
                                                    delicate fabrics or heavy loads, the Clean Wave ensures thorough cleaning every time.
                                                </p>
                                            </div>
                                        </div>
                                        <div class="hr-line bg-light-gray"></div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-end gap-8">
                                        <div class="d-flex align-items-center gap-8">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
                                                <path
                                                    d="M12.7826 15.4085L13.077 15.5908L13.3101 15.3347C13.834 14.7593 14.5871 14.3988 15.4228 14.3988C16.9978 14.3988 18.2797 15.6808 18.2797 17.2558C18.2797 18.8306 16.9978 20.1126 15.4228 20.1126C13.8478 20.1126 12.5658 18.8306 12.5658 17.2558C12.5658 16.8906 12.6355 16.5418 12.761 16.2201L12.8871 15.897L12.5923 15.7144L7.20287 12.3764L6.90843 12.1941L6.67532 12.4502C6.15148 13.0258 5.39838 13.3862 4.56268 13.3862C2.98768 13.3862 1.70573 12.1043 1.70573 10.5293C1.70573 8.95442 2.9877 7.67233 4.56268 7.67233C5.39834 7.67233 6.15147 8.03286 6.67535 8.60838L6.90847 8.86447L7.20287 8.68212L12.5923 5.34412L12.8871 5.1615L12.761 4.83842C12.6355 4.51675 12.5658 4.16794 12.5658 3.80291C12.5658 2.22792 13.8478 0.945963 15.4228 0.945963C16.9978 0.945963 18.2797 2.22779 18.2797 3.80276C18.2797 5.37775 16.9978 6.65971 15.4228 6.65971C14.5871 6.65971 13.834 6.29917 13.3101 5.72366L13.077 5.46757L12.7826 5.64992L7.39305 8.98807L7.09806 9.17078L7.22436 9.49396C7.34992 9.81524 7.41947 10.164 7.41947 10.5293C7.41947 10.8944 7.34992 11.2432 7.22434 11.5646L7.0981 11.8878L7.39305 12.0705L12.7826 15.4085ZM15.4228 1.30632C14.0458 1.30632 12.9262 2.42594 12.9262 3.80291C12.9262 5.17988 14.0458 6.2995 15.4228 6.2995C16.7998 6.2995 17.9194 5.17988 17.9194 3.80291C17.9194 2.42594 16.7998 1.30632 15.4228 1.30632ZM2.06594 10.5293C2.06594 11.9063 3.18558 13.0259 4.56268 13.0259C5.93968 13.0259 7.05911 11.9062 7.05911 10.5293C7.05911 9.15235 5.93968 8.03269 4.56268 8.03269C3.18558 8.03269 2.06594 9.15229 2.06594 10.5293ZM15.4228 14.7591C14.0458 14.7591 12.9262 15.8787 12.9262 17.2556C12.9262 18.6326 14.0458 19.7522 15.4228 19.7522C16.7998 19.7522 17.9194 18.6326 17.9194 17.2556C17.9194 15.8787 16.7998 14.7591 15.4228 14.7591Z"
                                                    fill="#464646" stroke="#464646" stroke-width="0.833332" />
                                            </svg>
                                            <p class="fw-500 font-sec black">Share:</p>
                                        </div>
                            ...
                            <div class="description-wrapper">
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade" id="nav-desc" role="tabpanel"
                                        ...
                                        <p class="mb-8">
                                            Our fresh, crisp lettuce is the perfect base for your salads, sandwiches, and wraps. Grown with care, this nutrient-rich
                                            leafy green is a kitchen staple, known for its refreshing taste and versatility. Whether you’re preparing a light salad,
                                            adding crunch to your burgers, or crafting a healthy wrap, our lettuce provides the perfect balance of flavor and
                                            texture.
                                        </p>
                                        <p class="mb-32">
                                            Our fresh, crisp lettuce is the perfect base for your salads, sandwiches, and wraps. Grown with care, this nutrient-rich
                                        ...
                                        <p class="mb-12">Lorem ipsum dolor sit amet consectetur. Est morbi cum bibendum id eleifend ultrices enim nec. Vitae morbi mus
                                            imperdiet tincidunt ultrices hendrerit. Lobortis donec massa fermentum aliquet sapien. Magna risus donec aliquam
                                            diam aliquet consectetur. Etiam accumsan ipsum augue sed vitae. Tortor volutpat et dui in malesuada euismod. Sociis
                                            aenean porttitor aliquet sit amet.</p>
                                        <p>Nibh nunc at eget netus dictumst aenean ultricies ligula nunc. Morbi elit eu neque amet nulla posuere amet dictum.
                                            Nisl viverra sagittis elit proin donec sed. Enim ipsum at dolor nulla. Accumsan in commodo in facilisi ut euismod
                                            imperdiet dui. Fringilla pellentesque consectetur ac nibh diam morbi mattis iaculis.</p>
                                    </div>
                                    <div class="tab-pane fade show active" id="nav-review" role="tabpanel" aria-labelledby="nav-review-tab">
                                        <div class="comments-sec mb-48">
                                            ...
                                            <div class="comment-box mb-24">
                                                <img src="assets/media/users/user-4.png" alt="" class="br-4">
                                                <div class="block">
                                                    <div class="top-row mb-16">
                                                        <div class="info">
                                                            <h6 class="fw-600 black">Ethan Clarke</h6>
                                                        </div>
                                                        <h6 class="color-quant">★ ★ ★ ★ <span class="medium-gray">★</span></h6>
                                                    </div>
                                                    <p>Lorem ipsum dolor sit amet consectetur. Est morbi cum bibendum id eleifend ultrices enim nec. Vitae
                                                        morbi mus
                                                        imperdiet tincidunt ultrices hendrerit. Lobortis donec massa fermentum aliquet sapien. Magna risus
                                                        donec aliquam
                                            ...
                                            <div class="comment-box">
                                                <img src="assets/media/users/user-5.png" alt="" class="br-4">
                                                <div class="block">
                                                    <div class="top-row mb-16">
                                                        <div class="info">
                                        ...
                                        <div class="review-form">
                                            ...
                                            <form method="post" action="https://uiparadox.co.uk/templates/toys-shop/v2/product-detail.php" class="form-group product-form">
                                                <div class="row">
                                                    <div class="col-sm-12">
            ...
            <section class="feature-products py-40 mb-48">
                <div class="container-fluid">
                                        ...
                                        <div class="row mb-24 row-gap-2">
                                            <div class="col-md-6">
                                                <a href="#" class="cus-btn light-btn w-100">
                                                    <svg class="arr-2" xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
                                                        <mask id="path-1-inside-1_14272_18" fill="white">
                                                            <path
                                                                d="M6.44378 13.4591H6.4447L6.44699 13.459H17.0703C17.3318 13.459 17.5618 13.2855 17.6337 13.034L19.9774 4.8309C20.0279 4.65405 19.9925 4.46393 19.8819 4.31714C19.7711 4.17035 19.5979 4.08398 19.4141 4.08398H5.09247L4.67361 2.19907C4.61395 1.93097 4.37622 1.74023 4.10156 1.74023H0.585937C0.262298 1.74023 0 2.00253 0 2.32617C0 2.64981 0.262298 2.91211 0.585937 2.91211H3.63159C3.70575 3.24612 5.63598 11.9323 5.74707 12.4321C5.12436 12.7028 4.6875 13.3236 4.6875 14.0449C4.6875 15.0142 5.47607 15.8027 6.44531 15.8027H17.0703C17.3939 15.8027 17.6562 15.5404 17.6562 15.2168C17.6562 14.8932 17.3939 14.6309 17.0703 14.6309H6.44531C6.12228 14.6309 5.85937 14.3679 5.85937 14.0449C5.85937 13.7223 6.12136 13.4599 6.44378 13.4591ZM18.6372 5.25586L16.6283 12.2871H6.91528L5.35278 5.25586H18.6372Z" />
                                                            <path
                                                                d="M5.85937 17.5605C5.85937 18.5298 6.64794 19.3184 7.61718 19.3184C8.58642 19.3184 9.37499 18.5298 9.37499 17.5605C9.37499 16.5913 8.58642 15.8027 7.61718 15.8027C6.64794 15.8027 5.85937 16.5913 5.85937 17.5605ZM7.61718 16.9746C7.94021 16.9746 8.20312 17.2375 8.20312 17.5605C8.20312 17.8836 7.94021 18.1465 7.61718 18.1465C7.29415 18.1465 7.03125 17.8836 7.03125 17.5605C7.03125 17.2375 7.29415 16.9746 7.61718 16.9746Z" />
...
<!-- Mirrored from uiparadox.co.uk/templates/toys-shop/v2/product-detail.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Feb 2026 12:38:29 GMT -->
</html>