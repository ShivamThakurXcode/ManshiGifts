...
<!-- Mirrored from uiparadox.co.uk/templates/toys-shop/v2/contact.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Feb 2026 12:38:34 GMT -->
<head>
    <meta charset="UTF-8">
...
<body class="tt-smooth-scroll">
    ...
    <div id="scroll-container" class="main-wrapper">
        ...
        <main class="main-wrapper">
                    ...
                    <div class="container-fluid">
                        <div class="title-banner-heading pt-40 pb-16 text-center">
                            <div class="row align-items-center row-gap-3">
                                ...
                                <div class="col-md-4">
                                    <h1 class="black fw-700 text-center">Contact Us</h1>
                                </div>
                                <div class="col-md-4">
            ...
            <section class="contact-section pt-40 pb-80">
                <div class="container-fluid">
                    <div class="opening-hours mb-16">
                        <h4 class="mb-12 fw-600 black">Open Hours</h4>
                        <p class="mb-24">We're Here for You During These Hours.</p>
                        <div class="row row-gap-3">
                            <div class="col-lg-4 col-md-4">
                                <div class="days-block">
                                    <h6 class="black fw-600 mb-12">Monday</h6>
                                    <p>9:00 AM - 7:00 PM</p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4">
                                <div class="days-block">
                                    <h6 class="black fw-600 mb-12">Saturday</h6>
                                    <p>9:00 AM - 7:00 PM</p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4">
                                <div class="days-block">
                                    <h6 class="black fw-600 mb-12">Sunday</h6>
                                    <p>Closed</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row row-gap-3">
                        <div class="col-lg-6">
                            <div class="opening-hours h-100">
                                <h4 class="fw-600 mb-12 black">Contact Us</h4>
                                <p class="mb-24">We're Here for You During These Hours.</p>
                                <div class="days-block contact-box p-24 mb-16">
                                    ...
                                    <div>
                                        <h6 class="fw-600 black mb-12">Phone Number</h6>
                                ...
                                <div class="days-block contact-box p-24 mb-16">
                                    ...
                                    <div>
                                        <h6 class="fw-600 black mb-12">Store Location</h6>
                                ...
                                <div class="days-block contact-box p-24">
                                    ...
                                    <div>
                                        <h6 class="fw-600 black mb-12">Email Address</h6>
                        ...
                        <div class="col-lg-6">
                            <div class="form-container">
                                <form method="post" class="contact-form">
                                    ...
                                    <p class="mb-24">Your email address is safe with us. Required fields are noted with
                                        *</p>
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-block mb-16">
                                                <input type="tel" name="phone" id="pnumber" class="form-control"
                                        ...
                                        <div class="col-md-12">
                                            <div class="cus-checkBox mb-24">
                                                ...
                                                <label for="remember">Save my Name, Email and Website in this
                                                    browser.</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
...
<!-- Mirrored from uiparadox.co.uk/templates/toys-shop/v2/contact.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Feb 2026 12:38:35 GMT -->
</html>