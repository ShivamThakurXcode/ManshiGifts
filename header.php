        ...
        <div class="container-fluid">
            <div class="header-center">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-3 col-md-8 col-sm-7 col-7 d-flex align-items-center justify-content-end">
                        <div class="header-buttons d-flex align-items-center gap-12">
                            <div class="mobile-nav__toggler d-lg-none d-block">
                            ...
                            <a href="#" class="button-block d-flex align-items-center cart-button d-none d-md-flex">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 32 33"
                                    fill="none">
                                    <path
...
<div class="mobile-nav__wrapper">
    ...
    <div class="mobile-nav__content">
        <div class="mobile-nav__close">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path d="M18 6L6 18M6 6L18 18" stroke="#0F0F0F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        </div>
