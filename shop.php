...
<head>
    ...
    <meta name="description" content="Toy Store">

    <title>Toy Store || Toys and Joy</title>
...
<body class="tt-smooth-scroll">
    ...
    <div id="scroll-container" class="main-wrapper">
        ...
        <header class="mb-16">
            <div class="header-section">
                <div class="bordered-line bg-blue-1">
                    <div class="container-fluid">
                        <div class="header-top">
                            <div class="social-icons d-lg-flex d-none align-items-center gap-8">
                                <p class="fw-500 white">Follow Us:</p>
                                <a href="#">
                                ...
                                <a href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                                        fill="none">
                                        <path
                                            d="M9.49467 6.77491L15.323 0H13.9418L8.88114 5.88256L4.83917 0H0.177246L6.28949 8.89547L0.177246 16H1.55844L6.90267 9.78782L11.1713 16H15.8332L9.49433 6.77491H9.49467ZM7.60293 8.97384L6.98364 8.08805L2.0561 1.03974H4.17754L8.15411 6.72795L8.77341 7.61374L13.9425 15.0075H11.8211L7.60293 8.97418V8.97384Z"
                                            fill="#FFFFFF" />
                                    </svg>
                                </a>
                                <a href="#">
                                ...
                                <a href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                                        fill="none">
                                        <path
                                            d="M3.76245 5.02075H0.75C0.491089 5.02075 0.28125 5.23071 0.28125 5.4895V15.5312C0.28125 15.7902 0.491089 16 0.75 16H3.76245C4.02136 16 4.2312 15.7902 4.2312 15.5312V5.4895C4.2312 5.23071 4.02136 5.02075 3.76245 5.02075ZM3.2937 15.0625H1.21875V5.95825H3.2937V15.0625Z"
                                            fill="#FFFFFF" />
                                        <path
                                            d="M2.25635 0C1.16724 0 0.28125 0.885986 0.28125 1.97485C0.28125 3.06396 1.16724 3.94983 2.25635 3.94983C3.34534 3.94983 4.2312 3.06384 4.2312 1.97485C4.2312 0.885986 3.34534 0 2.25635 0ZM2.25635 3.01233C1.6842 3.01233 1.21875 2.547 1.21875 1.97485C1.21875 1.40283 1.6842 0.9375 2.25635 0.9375C2.82837 0.9375 3.2937 1.40283 3.2937 1.97485C3.2937 2.547 2.82837 3.01233 2.25635 3.01233Z"
                                            fill="#FFFFFF" />
                                        <path
                                            d="M11.2941 4.95447C10.5815 4.95447 9.87927 5.12622 9.25037 5.44751C9.229 5.20837 9.0282 5.02075 8.78345 5.02075H5.77075C5.51196 5.02075 5.302 5.23071 5.302 5.4895V15.5312C5.302 15.7902 5.51196 16 5.77075 16H8.78345C9.04236 16 9.2522 15.7902 9.2522 15.5312V10.0083C9.2522 9.29785 9.83032 8.71985 10.5408 8.71985C11.2512 8.71985 11.8291 9.29785 11.8291 10.0083V15.5312C11.8291 15.7902 12.0391 16 12.2979 16H15.3104C15.5693 16 15.7792 15.7902 15.7792 15.5312V9.43958C15.7792 6.96643 13.7672 4.95447 11.2941 4.95447ZM14.8417 15.0625H12.7667V10.0083C12.7667 8.78088 11.7682 7.78235 10.5409 7.78235C9.31335 7.78235 8.3147 8.78088 8.3147 10.0083V15.0625H6.23962V5.95825H8.3147V6.30457C8.3147 6.48486 8.41809 6.64917 8.58069 6.72717C8.74316 6.80518 8.93604 6.78296 9.07678 6.67029C9.71155 6.16113 10.4784 5.89197 11.2941 5.89197C13.2502 5.89197 14.8417 7.4834 14.8417 9.43958V15.0625Z"
                                            fill="#FFFFFF" />
                                    </svg>
                                </a>
                            </div>
                            <div class="slider-container">
                                <p class="text-line white text-center">
                            ...
                            <div class="header-end">
                                <div class="drop-container">
                                    <div class="wrapper-dropdown white" id="dropdown2">
                                        <span class="selected-display white d-inline-flex align-items-center gap-8"
                                            id="destination2">
                                        ...
                                        <ul class="topbar-dropdown bg-lightest-gray">
                                            <li class="item black d-flex align-items-center gap-8">
                                                <img src="assets/media/icons/usd.png" alt="">
                                                USD
                                            </li>
                                            <li class="item black d-flex align-items-center gap-8">
                                                <img src="assets/media/icons/aed.png" alt="">
                                                AED
                                            </li>
                                            <li class="item black d-flex align-items-center gap-8">
                                                <img src="assets/media/icons/lb.png" alt="">
                                                LB
                                            </li>
                                            <li class="item black d-flex align-items-center gap-8">
                                                <img src="assets/media/icons/dem.png" alt="">
                                                DEM
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="drop-container">
                                    <div class="wrapper-dropdown white" id="dropdown">
                                        <span class="selected-display white" id="destination">English</span>
                                        ...
                                        <ul class="topbar-dropdown bg-lightest-gray">
                                            <li class="item black">English</li>
                                            <li class="item black">Spanish</li>
                                            <li class="item black">Italian</li>
                                            <li class="item black">Arabic</li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6 d-lg-block d-none">
                                <div class="mixin-container d-lg-flex d-none">
                                    <form action="https://uiparadox.co.uk/templates/toys-shop/v2/index.php" method="post">
        ...
        <main class="main-wrapper">
            ...
            <section class="title-banner mb-40">
                <div class="bg-blue-4">
                    <div class="container-fluid">
                        <div class="title-banner-heading pt-40 pb-16 text-center">
                            <div class="row align-items-center row-gap-3">
                                <div class="col-md-4">
                                    <img src="assets/media/about/banner-1.png" alt="" class="title-image">
                                </div>
                                <div class="col-md-4">
                                    <h1 class="black fw-700 text-center">Shop</h1>
                                </div>
                                <div class="col-md-4">
                                    <img src="assets/media/about/banner-2.png" alt="" class="title-image image-2">
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <img src="assets/media/about/cloud.png" alt="" class="cloud-banner">
            </section>
            <!-- TITLE BANNER END -->
                ...
                <div class="container-fluid">
                    <div class="row row-gap-4">
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                            <a href="shop.php" class="category-block">
                                <div class="image-box mb-16">
                                    <img src="assets/media/category/pc-1.png" alt="">
                                </div>
                                <div class="text-box">
                                    <h6 class="title-text text-1 fw-500 text-center">Game and Puzzle</h6>
                                </div>
                            </a>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                            <a href="shop.php" class="category-block">
                                ...
                                <div class="text-box">
                                    <h6 class="title-text text-2 fw-500 text-center">Indoor Play</h6>
                                </div>
                            </a>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                            <a href="shop.php" class="category-block">
                                ...
                                <div class="text-box">
                                    <h6 class="title-text text-6 fw-500 text-center">Toy Figures</h6>
                                </div>
                            </a>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                            <a href="shop.php" class="category-block">
                                ...
                                <div class="text-box">
                                    <h6 class="title-text text-3 fw-500 text-center">Kids Books</h6>
                                </div>
                            </a>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                            <a href="shop.php" class="category-block">
                                ...
                                <div class="text-box">
                                    <h6 class="title-text text-4 fw-500 text-center">Rockers and Rides</h6>
                                </div>
                            </a>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                            <a href="shop.php" class="category-block">
                                ...
                                <div class="text-box">
                                    <h6 class="title-text text-5 fw-500 text-center">Dolls</h6>
                                </div>
                            </a>
                        </div>
            ...
            <section class="feature-products py-40">
                <div class="container-fluid">
                    <div class="product-wrapper">
                        <div class="row row-gap-3 align-items-center mb-24">
                            <div class="col-lg-4 col-md-8">
                                <div class="d-flex align-items-center gap-16">
                                    ...
                                    <p class="black">Showing 01 - 09 of 30 Results</p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4">
                                <div class="grid-box justify-content-sm-center justify-content-end">
                                    <a href="shop-grid.php" class="svg-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="31"
                                            viewBox="0 0 22 31" fill="none">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                d="M3 6.6756C4.65685 6.6756 6 5.33245 6 3.6756C6 2.01874 4.65685 0.675598 3 0.675598C1.34315 0.675598 0 2.01874 0 3.6756C0 5.33245 1.34315 6.6756 3 6.6756ZM11 6.6756C12.6569 6.6756 14 5.33245 14 3.6756C14 2.01874 12.6569 0.675598 11 0.675598C9.34315 0.675598 8 2.01874 8 3.6756C8 5.33245 9.34315 6.6756 11 6.6756ZM22 3.6756C22 5.33245 20.6569 6.6756 19 6.6756C17.3431 6.6756 16 5.33245 16 3.6756C16 2.01874 17.3431 0.675598 19 0.675598C20.6569 0.675598 22 2.01874 22 3.6756ZM3 14.6756C4.65685 14.6756 6 13.3325 6 11.6756C6 10.0187 4.65685 8.6756 3 8.6756C1.34315 8.6756 0 10.0187 0 11.6756C0 13.3325 1.34315 14.6756 3 14.6756ZM14 11.6756C14 13.3325 12.6569 14.6756 11 14.6756C9.34315 14.6756 8 13.3325 8 11.6756C8 10.0187 9.34315 8.6756 11 8.6756C12.6569 8.6756 14 10.0187 14 11.6756ZM19 14.6756C20.6569 14.6756 22 13.3325 22 11.6756C22 10.0187 20.6569 8.6756 19 8.6756C17.3431 8.6756 16 10.0187 16 11.6756C16 13.3325 17.3431 14.6756 19 14.6756ZM6 19.6756C6 21.3325 4.65685 22.6756 3 22.6756C1.34315 22.6756 0 21.3325 0 19.6756C0 18.0187 1.34315 16.6756 3 16.6756C4.65685 16.6756 6 18.0187 6 19.6756ZM11 22.6756C12.6569 22.6756 14 21.3325 14 19.6756C14 18.0187 12.6569 16.6756 11 16.6756C9.34315 16.6756 8 18.0187 8 19.6756C8 21.3325 9.34315 22.6756 11 22.6756ZM22 19.6756C22 21.3325 20.6569 22.6756 19 22.6756C17.3431 22.6756 16 21.3325 16 19.6756C16 18.0187 17.3431 16.6756 19 16.6756C20.6569 16.6756 22 18.0187 22 19.6756ZM3 30.6756C4.65685 30.6756 6 29.3325 6 27.6756C6 26.0187 4.65685 24.6756 3 24.6756C1.34315 24.6756 0 26.0187 0 27.6756C0 29.3325 1.34315 30.6756 3 30.6756ZM14 27.6756C14 29.3325 12.6569 30.6756 11 30.6756C9.34315 30.6756 8 29.3325 8 27.6756C8 26.0187 9.34315 24.6756 11 24.6756C12.6569 24.6756 14 26.0187 14 27.6756ZM19 30.6756C20.6569 30.6756 22 29.3325 22 27.6756C22 26.0187 20.6569 24.6756 19 24.6756C17.3431 24.6756 16 26.0187 16 27.6756C16 29.3325 17.3431 30.6756 19 30.6756Z"
                                                fill="#D8C7DF" />
                                        </svg>
                                    </a>
                                    <a href="shop-grid-2.php" class="svg-2 active">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="31"
                                            viewBox="0 0 30 31" fill="none">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                d="M3 6.6756C4.65685 6.6756 6 5.33245 6 3.6756C6 2.01874 4.65685 0.675598 3 0.675598C1.34315 0.675598 0 2.01874 0 3.6756C0 5.33245 1.34315 6.6756 3 6.6756ZM11 6.6756C12.6569 6.6756 14 5.33245 14 3.6756C14 2.01874 12.6569 0.675598 11 0.675598C9.34315 0.675598 8 2.01874 8 3.6756C8 5.33245 9.34315 6.6756 11 6.6756ZM22 3.6756C22 5.33245 20.6569 6.6756 19 6.6756C17.3431 6.6756 16 5.33245 16 3.6756C16 2.01874 17.3431 0.675598 19 0.675598C20.6569 0.675598 22 2.01874 22 3.6756ZM27 6.6756C28.6569 6.6756 30 5.33245 30 3.6756C30 2.01874 28.6569 0.675598 27 0.675598C25.3431 0.675598 24 2.01874 24 3.6756C24 5.33245 25.3431 6.6756 27 6.6756ZM6 11.6756C6 13.3325 4.65685 14.6756 3 14.6756C1.34315 14.6756 0 13.3325 0 11.6756C0 10.0187 1.34315 8.6756 3 8.6756C4.65685 8.6756 6 10.0187 6 11.6756ZM11 14.6756C12.6569 14.6756 14 13.3325 14 11.6756C14 10.0187 12.6569 8.6756 11 8.6756C9.34315 8.6756 8 10.0187 8 11.6756C8 13.3325 9.34315 14.6756 11 14.6756ZM22 11.6756C22 13.3325 20.6569 14.6756 19 14.6756C17.3431 14.6756 16 13.3325 16 11.6756C16 10.0187 17.3431 8.6756 19 8.6756C20.6569 8.6756 22 10.0187 22 11.6756ZM27 14.6756C28.6569 14.6756 30 13.3325 30 11.6756C30 10.0187 28.6569 8.6756 27 8.6756C25.3431 8.6756 24 10.0187 24 11.6756C24 13.3325 25.3431 14.6756 27 14.6756ZM6 19.6756C6 21.3325 4.65685 22.6756 3 22.6756C1.34315 22.6756 0 21.3325 0 19.6756C0 18.0187 1.34315 16.6756 3 16.6756C4.65685 16.6756 6 18.0187 6 19.6756ZM11 22.6756C12.6569 22.6756 14 21.3325 14 19.6756C14 18.0187 12.6569 16.6756 11 16.6756C9.34315 16.6756 8 18.0187 8 19.6756C8 21.3325 9.34315 22.6756 11 22.6756ZM22 19.6756C22 21.3325 20.6569 22.6756 19 22.6756C17.3431 22.6756 16 21.3325 16 19.6756C16 18.0187 17.3431 16.6756 19 16.6756C20.6569 16.6756 22 18.0187 22 19.6756ZM27 22.6756C28.6569 22.6756 30 21.3325 30 19.6756C30 18.0187 28.6569 16.6756 27 16.6756C25.3431 16.6756 24 18.0187 24 19.6756C24 21.3325 25.3431 22.6756 27 22.6756ZM6 27.6756C6 29.3325 4.65685 30.6756 3 30.6756C1.34315 30.6756 0 29.3325 0 27.6756C0 26.0187 1.34315 24.6756 3 24.6756C4.65685 24.6756 6 26.0187 6 27.6756ZM11 30.6756C12.6569 30.6756 14 29.3325 14 27.6756C14 26.0187 12.6569 24.6756 11 24.6756C9.34315 24.6756 8 26.0187 8 27.6756C8 29.3325 9.34315 30.6756 11 30.6756ZM22 27.6756C22 29.3325 20.6569 30.6756 19 30.6756C17.3431 30.6756 16 29.3325 16 27.6756C16 26.0187 17.3431 24.6756 19 24.6756C20.6569 24.6756 22 26.0187 22 27.6756ZM27 30.6756C28.6569 30.6756 30 29.3325 30 27.6756C30 26.0187 28.6569 24.6756 27 24.6756C25.3431 24.6756 24 26.0187 24 27.6756C24 29.3325 25.3431 30.6756 27 30.6756Z"
                                                fill="#D8C7DF" />
                                        </svg>
                                    </a>
                                </div>
                            ...
                            <div class="col-lg-4 col-md-6 d-sm-block d-none">
                                <div
                                    class="d-flex align-items-center gap-16 justify-content-lg-end justify-content-start">
                                    <div class="d-flex align-items-center gap-8">
                                        <p class="black">Short by:</p>
                                        <div class="drop-container shop-dropdown">
                                            <div class="wrapper-dropdown" id="dropdown8">
                                                ...
                                                <svg id="drp-arrow8" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    <div class="drop-container shop-dropdown">
                                        <div class="wrapper-dropdown" id="dropdown9">
                                            <span class="selected-display" id="destination9">Show: 09</span>
                                            <svg id="drp-arrow9" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg"
                                                class="arrow transition-all ml-auto rotate-180">
                                                <path d="M7 14.5l5-5 5 5" stroke="currentColor" stroke-width="1.5"
                                                    stroke-linecap="round" stroke-linejoin="round"></path>
                                            ...
                                            <ul class="topbar-dropdown bg-lightest-gray">
                                                <li class="item dark-black">Show: 15</li>
                                                <li class="item dark-black">Show: 12</li>
                                                <li class="item dark-black">Show: 06</li>
                                                <li class="item dark-black">Show: 07</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row row-gap-4">
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="featured-product-card">
                                    <div class="image-box mb-16">
                                        <span class="sale-label subtitle fw-400 black">-16%</span>
                                        <a href="product-detail.php"><img src="assets/media/products/prodduct-1.png"
                                    ...
                                    <div class="product-desc">
                                        <div class="rating-star mb-12">
                                            <h6 class="orange-1">★★★★<span class="light-gray">★</span>&nbsp;<span
                                                    class="black subtitle fw-400">(02)</span></h6>
                                        </div>
                                        <a href="product-detail.php" class="product-title h5 fw-500 mb-12">Huggable
                                            Friends</a>
                                        <p class="light-gray mb-12">Lorem ipsum dolor sit amet consectetur. Id viverra
                                            cursus enim risus mattis urnanullam</p>
                                        <h6 class="black fw-500 mb-24">$18.00 &nbsp;<span
                                                class="subtitle text-decoration-line-through fw-400 light-gray">
                                                $20.00</span></h6>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="featured-product-card">
                                    <div class="image-box mb-16">
                                        <span class="sale-label subtitle fw-400 black">-16%</span>
                                        <a href="product-detail.php"><img src="assets/media/products/prodduct-2.png"
                                                class="product-image" alt=""></a>
                                        <div class="side-icons">
                                            <ul class="list-unstyled">
                                                <li>
                                    ...
                                    <div class="product-desc">
                                        ...
                                        <a href="product-detail.php" class="product-title h5 fw-500 mb-12">Snuggle
                                            Buddies</a>
                                        <p class="light-gray mb-12">Lorem ipsum dolor sit amet consectetur. Id viverra
                                            cursus enim risus mattis urnanullam</p>
                                        <h6 class="black fw-500 mb-24">$18.00 &nbsp;<span
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="featured-product-card">
                                    <div class="image-box mb-16">
                                        <span class="sale-label subtitle fw-400 black">-16%</span>
                                        <a href="product-detail.php"><img src="assets/media/products/prodduct-3.png"
                                                class="product-image" alt=""></a>
                                        <div class="side-icons">
                                            <ul class="list-unstyled">
                                                <li>
                                    ...
                                    <div class="product-desc">
                                        ...
                                        <a href="product-detail.php" class="product-title h5 fw-500 mb-12">Cuddle
                                            Companions</a>
                                        <p class="light-gray mb-12">Lorem ipsum dolor sit amet consectetur. Id viverra
                                            cursus enim risus mattis urnanullam</p>
                                        <h6 class="black fw-500 mb-24">$18.00 &nbsp;<span
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="featured-product-card">
                                    <div class="image-box mb-16">
                                        <span class="sale-label subtitle fw-400 black">-16%</span>
                                        <a href="product-detail.php"><img src="assets/media/products/prodduct-4.png"
                                                class="product-image" alt=""></a>
                                        <div class="side-icons">
                                            <ul class="list-unstyled">
                                                <li>
                                    ...
                                    <div class="product-desc">
                                        ...
                                        <a href="product-detail.php" class="product-title h5 fw-500 mb-12">Plush Toy
                                            Friends</a>
                                        <p class="light-gray mb-12">Lorem ipsum dolor sit amet consectetur. Id viverra
                                            cursus enim risus mattis urnanullam</p>
                                        <h6 class="black fw-500 mb-24">$18.00 &nbsp;<span
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="featured-product-card">
                                    <div class="image-box mb-16">
                                        <span class="sale-label subtitle fw-400 black">-16%</span>
                                        <a href="product-detail.php"><img src="assets/media/products/prodduct-5.png"
                                                class="product-image" alt=""></a>
                                        <div class="side-icons">
                                            <ul class="list-unstyled">
                                                <li>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="featured-product-card">
                                    <div class="image-box mb-16">
                                        <span class="sale-label subtitle fw-400 black">-16%</span>
                                        <a href="product-detail.php"><img src="assets/media/products/prodduct-6.png"
                                                class="product-image" alt=""></a>
                                        <div class="side-icons">
                                            <ul class="list-unstyled">
                                                <li>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="featured-product-card">
                                    <div class="image-box mb-16">
                                        <span class="sale-label subtitle fw-400 black">-16%</span>
                                        <a href="product-detail.php"><img src="assets/media/products/prodduct-7.png"
                                                class="product-image" alt=""></a>
                                        <div class="side-icons">
                                            <ul class="list-unstyled">
                                                <li>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="featured-product-card">
                                    <div class="image-box mb-16">
                                        <span class="sale-label subtitle fw-400 black">-16%</span>
                                        <a href="product-detail.php"><img src="assets/media/products/prodduct-8.png"
                                                class="product-image" alt=""></a>
                                        <div class="side-icons">
                                            <ul class="list-unstyled">
                                                <li>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="featured-product-card">
                                    <div class="image-box mb-16">
                                        <span class="sale-label subtitle fw-400 black">-16%</span>
                                        <a href="product-detail.php"><img src="assets/media/products/prodduct-9.png"
                                                class="product-image" alt=""></a>
                                        <div class="side-icons">
                                            <ul class="list-unstyled">
                                                <li>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="featured-product-card">
                                    <div class="image-box mb-16">
                                        <span class="sale-label subtitle fw-400 black">-16%</span>
                                        <a href="product-detail.php"><img src="assets/media/products/prodduct-10.png"
                                                class="product-image" alt=""></a>
                                        <div class="side-icons">
                                            <ul class="list-unstyled">
                                                <li>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="featured-product-card">
                                    <div class="image-box mb-16">
                                        <span class="sale-label subtitle fw-400 black">-16%</span>
                                        <a href="product-detail.php"><img src="assets/media/products/prodduct-11.png"
                                                class="product-image" alt=""></a>
                                        <div class="side-icons">
                                            <ul class="list-unstyled">
                                                <li>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="featured-product-card">
                                    <div class="image-box mb-16">
                                        <span class="sale-label subtitle fw-400 black">-16%</span>
                                        <a href="product-detail.php"><img src="assets/media/products/prodduct-12.png"
                                                class="product-image" alt=""></a>
                                        <div class="side-icons">
                                            <ul class="list-unstyled">
                                                <li>
                                ...
                                <a href="#" class="active">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32"
                                        ...
                                        <path
                                            ...
                                            stroke="#282525" stroke-width="2"></path>
                                    </svg>
                                </a>
                            </li>
                        </ul>
            ...
            <!-- FOOTER STart -->
            <footer>
                <img src="assets/media/images/footer-bg.png" alt="" class="bubble-image">
                <div class="bg-purple-1 pt-40 pb-24">
                    <div class="container-fluid">
                        <h3 class="fw-500 white text-center">@Toys Store</h3>
                            ...
                            <div class="row row-gap-4">
                                <div class="col-lg-4">
                                    <div class="store-desc">
                                        <a href="index-2.php"><img src="assets/media/logo.png" alt="" class="mb-16"></a>
                                        ...
                                        <h6 class="fw-500 white mb-16">Follow Us</h6>
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-6">
                                    <div class="footer-link-block">
                                        <h6 class="white mb-24">Useful Links</h6>
                                        <ul class="list-unstyled m-0">
                                            ...
                                            <li class="white"><a href="contact.php">Contact</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="footer-link-block spacing-block">
                                        <h6 class="white mb-24">Quick Links</h6>
                                        <ul class="list-unstyled m-0">
                                            <li class="white mb-8"><a href="about.php">About us</a></li>
                                            <li class="white mb-8"><a href="blog-grid.php">Blogs</a></li>
                                            <li class="white mb-8"><a href="shop-grid.php">Shop</a></li>
                                            <li class="white mb-8"><a href="shop-grid-2.php">Find a store</a></li>
                                            <li class="white"><a href="contact.php">Privacy Policy</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4">
                                    <div class="footer-link-block">
                                        <h6 class="white mb-24">Contact Us</h6>
                                        <ul class="list-unstyled contact-list mb-32">
                                            ...
                                            <li>
                                                ...
                                                <a href="mailto:info@example.com"
                                                    class="white">exampleinfo@gmail.com</a>
                                            </li>
                                        </ul>
                                        <h6 class="white fw- mb-16">Subscribe to Our Newslatter</h6>
                                        <form method="post" class="newsletter-form">
                                            <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" width="21"
                                                height="21" viewBox="0 0 21 21" fill="none">
                                                <path
                                                    d="M18.9088 3.15771H2.42444C1.45323 3.15771 0.666626 3.9492 0.666626 4.91553V15.4624C0.666626 16.4345 1.45901 17.2202 2.42444 17.2202H18.9088C19.8719 17.2202 20.6666 16.4378 20.6666 15.4624V4.91553C20.6666 3.95092 19.8831 3.15771 18.9088 3.15771ZM18.6626 4.32959C18.3035 4.68682 12.123 10.8348 11.9096 11.0471C11.5776 11.3791 11.1362 11.5619 10.6666 11.5619C10.1971 11.5619 9.75569 11.379 9.42256 11.046C9.27905 10.9032 3.16674 4.82311 2.67061 4.32959H18.6626ZM1.8385 15.2239V5.15479L6.90249 10.1921L1.8385 15.2239ZM2.67135 16.0483L7.73334 11.0185L8.59502 11.8757C9.14838 12.429 9.88409 12.7338 10.6666 12.7338C11.4492 12.7338 12.1849 12.429 12.7371 11.8768L13.5999 11.0185L18.6619 16.0483H2.67135ZM19.4948 15.2239L14.4308 10.1921L19.4948 5.15479V15.2239Z"
                                                    fill="white" />
                                            </svg>
                                            <input type="email" class="form-control form-control-nav bg-transparent"
                        ...
                        <p class="text-center white fw-500">@2025 All Rights Copyright <a href="#"
                                class="yellow-1 fw-700"> Toys Store.</a> Design & Developed By <span
                                class="yellow-1 fw-700">UIPARADOX</span></p>
                    </div>
                </div>
            </footer>
            <!-- FOOTER End -->
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="index-2.php" aria-label="logo image"><img src="assets/media/logo.png" alt=""></a>
            </div>
    ...
    <div class="shop-sidebar toggle-sidebar">
        <form action="https://uiparadox.co.uk/templates/toys-shop/v2/blog-grid.php" class="blog-searchbar mb-24">
            <input type="text" name="search" id="searchBar" class="form-control" placeholder="Search Here...">
            <button type="submit" class="subtitle">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                    <path
                        d="M6.49375 0C10.0744 0 12.9875 2.91309 12.9875 6.49375C12.9875 8.11563 12.3898 9.60053 11.4032 10.7398L15.8627 15.1998C16.0458 15.3829 16.0457 15.6797 15.8627 15.8628C15.6796 16.0458 15.3828 16.0457 15.1998 15.8627L10.7403 11.4028C9.60094 12.3897 8.11584 12.9875 6.49375 12.9875C2.91309 12.9875 0 10.0744 0 6.49375C0 2.91309 2.91309 0 6.49375 0ZM6.49375 12.05C9.5575 12.05 12.05 9.55747 12.05 6.49375C12.05 3.43003 9.55747 0.9375 6.49375 0.9375C3.43003 0.9375 0.9375 3.43003 0.9375 6.49375C0.9375 9.55747 3.43003 12.05 6.49375 12.05Z"
                        fill="#141516" />
                </svg>
            </button>
        </form>
        ...
        <div class="category-block box-1 mb-24">
            <div class="title mb-24" data-count="1">
                <h6 class="black">Availability</h6>
                <span>
        ...
        <div class="category-block box-2 mb-24">
            <div class="title mb-24" data-count="2">
                <h6 class="black">Product Categories</h6>
                <span>
                    <i class="far fa-horizontal-rule"></i>
                </span>
            </div>
            <div class="content-block">
                <div class="d-flex align-items-center justify-content-between mb-16">
                    <a href="shop-grid-2.php" class="black">Game and Puzzle</a>
                    <p class="light-gray">(10)</p>
                </div>
                <div class="d-flex align-items-center justify-content-between mb-16">
                    <a href="shop-grid-2.php" class="black">Indoor Play</a>
                    <p class="light-gray">(08)</p>
                </div>
                <div class="d-flex align-items-center justify-content-between mb-16">
                    <a href="shop-grid-2.php" class="black">Kids Books</a>
                    <p class="light-gray">(20)</p>
                </div>
                <div class="d-flex align-items-center justify-content-between mb-16">
                    <a href="shop-grid-2.php" class="black">Dolls</a>
                    <p class="light-gray">(05)</p>
                </div>
                <div class="d-flex align-items-center justify-content-between">
                    <a href="shop-grid-2.php" class="black">Toy Figures</a>
                    <p class="light-gray">(12)</p>
                </div>
            </div>
        </div>
        <div class="hr-line bg-light-gray mb-24"></div>
        <div class="category-block box-3 mb-24">
            <div class="title mb-24" data-count="3">
                <h6 class="black">Filter By Price</h6>
                <span>
                    <i class="far fa-horizontal-rule"></i>
                </span>
            </div>
            <div class="content-block">
                <div class="wrapper">
                    <div class="price-input mb-24">
                        <div class="field">
                            <div class="black mb-4p">Low</div>
                            <div class="sidebar-price-block">
                                <input type="number" class="input-min" value="2500">
                            </div>
                        </div>
                        <div class="field">
                            <div class="black mb-4p">High</div>
                            <div class="sidebar-price-block">
        ...
        <div class="hr-line bg-light-gray mb-24"></div>
        <div class="category-block box-4">
            <div class="title mb-24" data-count="4">
                <h6 class="black">Feature Products</h6>
                <span>
                    <i class="far fa-horizontal-rule"></i>
                </span>
            </div>
            <div class="content-block mt-24">
                <a href="blog-detail.php" class="recent-blogs d-flex gap-16 align-items-center mb-24">
                    <div class="image-box d-flex flex-shrink-0">
                        <img src="assets/media/products/product-sidebar-1.png" alt="" class="br-8">
                    </div>
                    <div>
                        <h6 class="text fw-600 mb-8">Plush Toy Friends</h6>
                        <div class="d-flex align-items-center mb-8">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14"
                                fill="none">
                                <path
                                    d="M7 0.529297L8.5716 5.36618H13.6574L9.5429 8.35554L11.1145 13.1924L7 10.2031L2.8855 13.1924L4.4571 8.35554L0.342604 5.36618H5.4284L7 0.529297Z"
                                    fill="#FC6102" />
                            </svg>
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14"
                                fill="none">
                        ...
                        <p class="black fw-500"> <span
                                class="text-decoration-line-through subtitle light-gray">$20.00</span> $18.00 </p>
                    </div>
                </a>
                <a href="blog-detail.php" class="recent-blogs d-flex gap-16 align-items-center mb-24">
                    <div class="image-box d-flex flex-shrink-0">
                        <img src="assets/media/products/product-sidebar-2.png" alt="" class="br-8">
                    </div>
                    <div>
                        <h6 class="text fw-600 mb-8">Plush Toy Friends</h6>
                        <div class="d-flex align-items-center mb-8">
                ...
                <a href="blog-detail.php" class="recent-blogs d-flex gap-16 align-items-center">
                    <div class="image-box d-flex flex-shrink-0">
                        <img src="assets/media/products/product-sidebar-3.png" alt="" class="br-8">
                    </div>
                    <div>
                        <h6 class="text fw-600 mb-8">Plush Toy Friends</h6>
                        <div class="d-flex align-items-center mb-8">
                            ...
                            <div class="row row-gap-4">
                                ...
                                <div class="col-lg-6">
                                    <div class="product-text-container bg-white br-20">
                                        ...
                                        <h4 class="fw-600 black mb-16">Cuddly Animal Pals </h4>
                                        <div class="d-flex align-items-center flex-wrap gap-8 mb-16">
                                            <h6 class="yellow-1">★★★★★</h6>
                                        ...
                                        <p class="mb-24">
                                            Lorem ipsum dolor sit amet consectetur. Ut sit neque consectetur cras tempus
                                            ornare libero. Lacus imperdiet sem
                                            pretium ac xmassa.
                                        </p>
                                        ...
                                        <div class="row mb-24 row-gap-2">
                                            <div class="col-md-6">
                                                <a href="#" class="cus-btn light-btn w-100">
                                                    <svg class="arr-2" xmlns="http://www.w3.org/2000/svg" width="20"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th id="product-col" class="table-col">
                                            <img class="product-img mb-16" src="assets/media/products/prodduct-1.png"
                                                alt="">
                                            <span class="h6">
                                                <a href="#" class="product-link">Huggable Friends
                                                </a>
                                            </span>
                                        </th>
                                        <th class="table-col">
                                            <img class="product-img mb-16" src="assets/media/products/prodduct-2.png"
                                                alt="">
                                            <span class="h6">
                                                <a href="#" class="product-link">Snuggle Buddies
                                                </a>
                                            </span>
                                        </th>
                                        <th class="table-col">
                                            <img class="product-img mb-16" src="assets/media/products/prodduct-3.png"
                                                alt="">
                                            <span class="h6">
                                                <a href="#" class="product-link">Cuddle Companions
                                                </a>
                                            </span>
                                        </th>
                                        <th class="table-col">
                                            <img class="product-img mb-16" src="assets/media/products/prodduct-4.png"
                                                alt="">
                                            <span class="h6">
                                                <a href="#" class="product-link">Plush Toy Friends
                                                </a>
                                            </span>
                                        </th>
                                        <th class="table-col">
                                            <img class="product-img mb-16" src="assets/media/products/prodduct-5.png"
                                                alt="">
                                            <span class="h6">
                                                <a href="#" class="product-link">Plush Toy Friends</a>
                                            </span>
                                        </th>
                                    </tr>
                                </thead>
...
<!-- Mirrored from uiparadox.co.uk/templates/toys-shop/v2/shop-grid-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Feb 2026 12:38:24 GMT -->
</html>